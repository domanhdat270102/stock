...
const SaveBtn: React.FC<SaveBtnProps> = ({ data }) => {
  ...
  return (
    <button
      className="outline-0 bg-none cursor-pointer border-0"
...
const TableComponent: React.FC = () => {
  ...
  return (
    <>
      <div className="flex flex-col mt-9 border border-gray-100 rounded">
        {cryptoData ? (
          <table className="w-full table-auto">
            ...
            <tbody>
              {cryptoData.map((data: CryptoData) => (
                <tr
                  key={data.id}
      ...
      <div className="flex justify-between items-center mt-4 h-[2rem] capitalize">
        <span>
          Data provided By{" "}
          <a
            className="text-cyan"
